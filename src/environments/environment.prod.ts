...
//   cloudUrl:'https://us-central1-rare-lambda-245821.cloudfunctions.net/app/', // use for live side
 ...
 //domain:'http://localhost:63050/',
  firebase: {
    ...
    vapidKey:'BO4WWXotLOXvfca1TpTGDlX9Lh4fhG6NcBHohXSRH49uTOmny2xa55Plk0R9c2WmSJ6nEqyZTml390WEL7i7ViY',
  },
...
Login:{
  ...
  GetUserViryficationDetails:'api/RESTAuthentication/GetUserViryficationDetails',
  ...
  CompanyChangePassword:"api/RESTAuthentication/PostCompanyUserChangePassword",
...
GetActivityTracking:"api/UserActivityTracting/GetActivityTrackingFilterDetails",
GetUserFilterList:"api/UserActivityTracting/GetUserFilterList",
DeleteActivityTrackingPhoto:"api/UserActivityTracting/DeleteActivityTrackingPhoto",
...
GetMainCategoryConfigration:"api/RESTIPL/GetMainCategoroyConfigurationDetails",
PostMainCategoryConfigration:"api/RESTIPL/PostMainCategoroyConfigurationDetails",
...
AddAdminFilterAllowablesCategory:"api/Allowables/AddUpdateFilterAdminAllowablesCategory",
//28)Allowables  APIs
...
AdminFilterPhotoHeaderTemplate:"api/WOCTASK/AdminFilterPhotoHeaderTemplate",
...
GetCurrentlyDueContractor:"api/ContractorReport/GetCurrentlyDueContractorReport",
...
ClientResult:{
  ...
  ContractorInvoicePdfDetailsData:"api/WOCTASK/ContractorInvoicePdfDetailsData",
  ...
  TaskDeleteClientResultsPhotos:"api/RESTIPL/PostTaskDeleteClientResultsPhotos",
  ...
  GetCLientResultPhotosMasterHistory:"api/MultiPhoto/GetCLientResultPhotosMasterHistory",
  ...
  GetClientResultInvoiceWOIDAutoCom:"api/WOCTASK/GetClientResultInvoiceWOIDAutoCom",
...
Accounting:{
  ...
  AccountDetailsDrd:'api/AccountType/GetDropDownAccountDetailsByAccountTypeId',
  ...
  Report:{
    ...
    GetAccountPayableReportsPDF:'api/AccountReport/GetAccountPayableReportsPDF',

    //2)Account Receivable
    GetAccountReceivableReports:'api/AccountReport/GetAccountReceivableReports',
    GetAccountReceivableReportsPDF:'api/AccountReport/GetAccountReceivableReportsPDF',
    ...
    GetProfitAndLossByCustomerReports:'api/AccountReport/GetProfitAndLossByCustomerReports',
    GetProfitLossByCustomerPDF:'api/AccountReport/GetProfitLossByCustomerPDF',

    //8)Profit And Loss By Month
    GetProfitAndLossByMonthReports:'api/AccountReport/GetProfitAndLossByMonthReports',
    GetProfitLossByMonthPDF:'api/AccountReport/GetProfitLossByMonthPDF',

    //9)Profit And Loss Comparison
    GetProfitAndLossComparisonReports:'api/AccountReport/GetProfitAndLossComparisonReports',
    GetProfitLossComparisonPDF:'api/AccountReport/GetProfitLossComparisonPDF',

    //10)Profit And Loss Details
    GetProfitAndLossDetailsReports:'api/AccountReport/GetProfitAndLossDetailsReports',
    GetProfitAndLossDetailsPDF:'api/AccountReport/GetProfitAndLossDetailsPDF',
