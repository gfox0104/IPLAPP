...
@Component({
  selector: 'app-loan-status-form-card',
  templateUrl: './loan-status-form-card.component.html',
  styleUrls: ['./loan-status-form-card.component.scss']
})
export class LoanStatusFormCardComponent implements OnInit {
