...
@Component({
  selector: 'app-lot-pricing-filter-form-card',
  templateUrl: './lot-pricing-filter-form-card.component.html',
  styleUrls: ['./lot-pricing-filter-form-card.component.scss']
})
export class LotPricingFilterFormCardComponent implements OnInit {
  @Input() title;
  @Input() fields;
  @Input() modelObj;
  @Input() isEditDisable;
