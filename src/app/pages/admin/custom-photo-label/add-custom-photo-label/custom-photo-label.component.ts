...
import { ViewCustomPhotoLabelModel } from '../view-custom-photo-label/view-custom-photo-label-model';
...
import { ViewCustomPhotoLabelServices } from '../view-custom-photo-label/view-custom-photo-label.service';
import { IplAppModalContent } from 'src/app/components';
import { FormFields } from '../constants';
import { MultiDropdowns } from './custom-photo-label-multi-dropdowns';
import { AddUserServices } from 'src/app/pages/user/add-user/add-user.service';
import { DocumentAndFormsDTO } from 'src/app/pages/contractor/document-form/document-form-model';

@Component({
  templateUrl: "./custom-photo-label.component.html"
})
...
export class CustomPhotoLableComponent implements OnInit {
  ...
  clickBack() {
    this.router.navigate(['/home/customphoto/labelview'])
  }
