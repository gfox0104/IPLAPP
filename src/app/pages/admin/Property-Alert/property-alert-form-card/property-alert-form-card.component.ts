...
@Component({
  selector: 'app-property-alert-form-card',
  templateUrl: './property-alert-form-card.component.html',
  styleUrls: ['./property-alert-form-card.component.scss']
})
export class PropertyAlertFormCardComponent implements OnInit {
