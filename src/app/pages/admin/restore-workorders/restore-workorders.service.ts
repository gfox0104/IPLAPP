...
export class RestoreWorkOrderServices {
  ...
  public ViewUserData(Modelobj: RestoreWorkOrderModel) {
    ////dfebugger
     var ANYDTO: any = {};
...
// public AddUpdateFilterAdminuserData(Modelobj: RestoreWorkOrderModel) {
//   let ANYDTO: any = {};
...
private apiUrpast = BaseUrl + environment.Admin.getRestoredWorkOrderData;
public getRestroredWorkOrderData(Modelobj: RestoreWorkOrderModel) {
  //debugger
  var ANYDTO: any = {};
...
private workOrdderEditDelte = BaseUrl + environment.WorkOrder.PostWorkOrder;

    public workOrdderEditDelteData(Modelobj: RestoreWorkOrderModel) {
      var ANYDTO: any = {};
      ANYDTO.workOrder_ID = Modelobj.workOrder_ID;
      ...
      headers = headers.append('Authorization', 'Bearer ' + `${this.token}`);
      return this._http
        .post<any>(this.workOrdderEditDelte, ANYDTO, { headers: headers })
        .pipe(
          tap((data) => {
            return data;
          }),
