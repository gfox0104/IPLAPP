...
@Component({
  selector: 'app-background-provider-form-card',
  templateUrl: './background-provider-form-card.component.html',
  styleUrls: ['./background-provider-form-card.component.scss']
})
export class BackgroundProviderFormCardComponent implements OnInit {
