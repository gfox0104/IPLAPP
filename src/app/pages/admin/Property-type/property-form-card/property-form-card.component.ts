...
@Component({
  selector: 'app-property-form-card',
  templateUrl: './property-form-card.component.html',
  styleUrls: ['./property-form-card.component.scss']
})
export class PropertyFormCardComponent implements OnInit {
  @Input() title;
  @Input() fields;
  @Input() modelObj;
  @Input() isEditDisable;
