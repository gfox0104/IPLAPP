...
@Component({
  selector: 'app-work-order-completion-tracker',
  templateUrl: './work-order-completion-tracker.component.html',
  styleUrls: ['./work-order-completion-tracker.component.scss']
})
export class WorkOrderCompletionTrackerComponent implements OnInit {
