...
export class DocumentAndFormsServices {
  ...
  private apiUrlPOST = this.baseUrl + environment.Resources.PostAddFolder;
  ...
  async uploadDocument(Modelobj: FileMasterModel) {
   ...
   const uploadapi = this.baseUrl + environment.cloudUrl +'uploadDocument';
    // const uploadapi = environment.cloudUrl + 'upload';
    // const uploadapi = 'http://localhost:5000/uploadDocument';environment.cloudUrl + 'upload';
    const request = {
  ...
  private apiUrlget = this.baseUrl + environment.Resources.GetFileFolder;
  ...
  private apiUrlsget = this.baseUrl + environment.Resources.GetParentFolder;
  ...
  private apiUrlfget = this.baseUrl + environment.Resources.GetEditFile;
  ...
  //update file details
  private apiUrluget = this.baseUrl + environment.Resources.UpdateFileMaster;
...
//debugger
  ...
  private apiUrlAutoAssign = this.baseUrl + environment.Resources.UpdateFileAutoAssign;
  ...
  // delete folder
 private deleteFolderUrl = this.baseUrl + environment.Resources.PostAddFolder;
 ...
 // delete file
 private deleteApiUrl = this.baseUrl + environment.Resources.UpdateFileMaster;
